...
import com.aakash.filterlist.FilterRVAdapter;
import com.aakash.model.FilterRvModel;
import com.aakash.widget.SampleCameraGLView;
...
public class BaseCameraActivity extends AppCompatActivity implements FilterRvListner {
    ...
    private FilterRVAdapter filterRVAdapter;
    private List<FilterRvModel> modelList;
    ...
    protected void onCreateActivity() {
       ...
       // getWindow().setStatusBarColor();
        ...
        filterRVAdapter=new FilterRVAdapter(this,modelList,this);
        ...
        recordBtn.setOnClickListener(v -> {
            ...
            if (recordBtn.getText().equals(getString(R.string.app_record))) {
                ...
                sharedPreferences = this.getSharedPreferences("com.aakash.imageandvideopicker", Context.MODE_PRIVATE);
...
//btn_switch_camera
        findViewById(R.id.iv_switch_camera).setOnClickListener(v -> {
            releaseCamera();
       ...
       // final List<FilterType> filterTypes = FilterType.createFilterList();
        ...
        {
            modelList.add(new FilterRvModel(filterType,"https://cdn.pixabay.com/photo/2021/11/24/17/39/seal-6821775_1280.jpg"));
        }
...
//    }
    ...
    @Override
    public void onFilterClick(int postion) {
        if (GPUCameraRecorder != null) {
            GPUCameraRecorder.setFilter(FilterType.createGlFilter(filterTypes.get(postion), getApplicationContext()));
        }
